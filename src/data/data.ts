...
export const cardData: CardInterface[] = [
  ...
  },
  {
    ...
    logoURL: ['ts-logo.png'],
    name: 'TypeScript',
    description: 'TypeScript is a programming language that is a strict syntactical superset of JavaScript developed by Microsoft.',
  ...
  },
  {
    ...
    name: 'C#, .Net Core',
    description: '.NET Core is an open-source framework maintained by Microsoft that is used to build several types of applications.',
